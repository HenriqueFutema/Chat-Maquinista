    ...
    if (this.state.msg !== "") {
      ...
      this.setState({
        mensagens: [
          ...
          { author: "Você", content: input_msg, type: "text", user: true }
        ]
      });
      ...
      msg.data.response.output.generic.map(txt =>
        this.setState({
          mensagens: [
            ...
            {
              author: "Bot",
              content: txt.text || txt.source,
              type: txt.response_type,
              user: false
            }
          ]
        })
    ...
    return (
      <div>
        ...
        <div className="container chat-container">
          <div className="row mt-3">
            <div className="col-8 msg p-2">
              <h6>Bot:</h6>
              <p>
                Olá {this.state.name}, tudo bem? Prazer eu sou o FIAP Assistant
              </p>
            </div>
          </div>
        ...
        <form
          ...
          className="form-group row mt-5 chat-inp"
        >
          <input
            className="form-control m-3 col-lg-10 col-md-9 col-6 input-entrar"
            ref="inpMsg"
            disabled={this.state.validateInpput}
            type="text"
          ...
          <button type="submit" className="btn btn-primary btn-enviar btn-lg">
            >
          </button>
        </form>
      </div>
